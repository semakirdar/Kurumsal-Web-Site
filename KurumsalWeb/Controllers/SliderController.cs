    ...
    public class SliderController : Controller
    {
        ...
        public ActionResult Edit([Bind(Include = "SliderId,Baslik,Aciklama,ResimURL")] Slider slider, HttpPostedFileBase ResimURL,int id)
        {
...

            {
                ...
                if (ResimURL != null)
                {
                    if (System.IO.File.Exists(Server.MapPath(s.ResimURL)))//daha önce yüklediğimiz rresim var mı kontrol et varsa sil
                    {
        ...
        {
            Slider slider = db.Slider.Find(id);
            if (System.IO.File.Exists(Server.MapPath(slider.ResimURL)))//daha önce yüklediğimiz rresim var mı kontrol et varsa sil
            {
